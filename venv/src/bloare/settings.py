"""
Django settings for bloare project.
...
# Overwriting the default User model with custom User model
...
WSGI_APPLICATION = 'bloare.wsgi.application'
...
# Imported from config.email_info
